...
| `CHANGE_REQUEST_FIELD_LABELS_FR`               | Téléphone · Téléphone 2 · Adresse · Repère                                                                                                                                                                                                                                                              |
| `CHANGE_REQUEST_STATUS_LABELS_FR`              | En attente · Appliquée · Refusée                                                                                                                                                                                                                                                                        |
| `parcelChangeRequestSchema`                    | Adresse trop courte · Indiquez au moins une modification                                                                                                                                                                                                                                                |
